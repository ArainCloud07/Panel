...
while true; do
    ...
    case $OPTION in
        1)
            ...
            bash <(curl -s https://raw.githubusercontent.com/ArainCloud07/Panel/refs/heads/main/convoy/install.sh)
        ...
        4)
            ...
            bash <(curl -s https://raw.githubusercontent.com/ArainCloud07/Panel/refs/heads/main/convoy/uninstall.sh)
            read -p "Press Enter to return..."
            ;;
